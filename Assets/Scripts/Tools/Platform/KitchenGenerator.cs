...
public class KitchenGenerator : MonoBehaviour
{
    ...
    private string[] OBSTACLE_LEFT_KITCHENS = { Pool.OBSTACLEKIT1, Pool.OBSTACLEKIT2, Pool.OBSTACLEKIT3, Pool.OBSTACLEKIT4, Pool.OBSTACLEKIT5, Pool.OBSTACLEKIT11, Pool.OBSTACLEKIT12, Pool.OBSTACLEKIT13 };
    private string[] OBSTACLE_RIGHT_KITCHENS = { Pool.OBSTACLEKIT6, Pool.OBSTACLEKIT7, Pool.OBSTACLEKIT8, Pool.OBSTACLEKIT9, Pool.OBSTACLEKIT10, Pool.OBSTACLEKIT14, Pool.OBSTACLEKIT15, Pool.OBSTACLEKIT16};
